...
export const FIXTURE_REPORTABLES_RESPONSE = {
  ...
  links: {
    first: 'https://smartmotors.app/api/saved-reports?page[size]=5&page[number]=1',
    last: 'https://smartmotors.app/api//aved-reports?page[size]=5&page[number]=2',
    prev: null,
    next: 'https://smartmotors.app/api//aved-reports?page[size]=5&page[number]=2'
  },
  meta: {
    current_page: 1,
    from: 1,
    last_page: 2,
    path: 'https://smartmotors.app/api/saved-reports',
    per_page: 5,
    to: 5,
    total: 10
  }
